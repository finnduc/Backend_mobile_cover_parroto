...
func RegisterRoutes(r *gin.RouterGroup, db *gorm.DB) {
	...
	r.GET("/vocabulary-decks/:deckId/items", ctrl.List)

	protected := r.Group("", middleware.ClerkAuthMiddleware())
	{
		protected.POST("/vocabulary-decks/:deckId/items", ctrl.Create)
	...
	{
		admin.GET("/vocabulary-decks/:deckId/items", adminCtrl.List)
		admin.POST("/vocabulary-decks/:deckId/items", adminCtrl.Create)
